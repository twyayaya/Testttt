...
### conv1 out 量化 ###
out0 = qq(out0 * conv1_output_scale)
out1 = qq(out1 * conv1_output_scale)
out2 = qq(out2 * conv1_output_scale)
out3 = qq(out3 * conv1_output_scale)
out4 = qq(out4 * conv1_output_scale)
out5 = qq(out5 * conv1_output_scale)
...
###conv2 out 量化 ###
conv2w0_out = qq(conv2w0_out * conv2_output_scale)
conv2w1_out = qq(conv2w1_out * conv2_output_scale)
conv2w2_out = qq(conv2w2_out * conv2_output_scale)
conv2w3_out = qq(conv2w3_out * conv2_output_scale)
conv2w4_out = qq(conv2w4_out * conv2_output_scale)
conv2w5_out = qq(conv2w5_out * conv2_output_scale)
conv2w6_out = qq(conv2w6_out * conv2_output_scale)
conv2w7_out = qq(conv2w7_out * conv2_output_scale)
conv2w8_out = qq(conv2w8_out * conv2_output_scale)
conv2w9_out = qq(conv2w9_out * conv2_output_scale)
conv2w10_out = qq(conv2w10_out * conv2_output_scale)
conv2w11_out = qq(conv2w11_out * conv2_output_scale)
conv2w12_out = qq(conv2w12_out * conv2_output_scale)
conv2w13_out = qq(conv2w13_out * conv2_output_scale)
conv2w14_out = qq(conv2w14_out * conv2_output_scale)
conv2w15_out = qq(conv2w15_out * conv2_output_scale)
